...
export class InputNumber extends BaseInput<InputNumberPassThrough> {
     ...
     * @group Props
     */
    @Input({ transform: booleanAttribute }) showButtons: boolean = this._componentDefaults?.inputNumber?.showButtons ?? false;
    /**
     * Whether to format the value.
     * @group Props
     */
    @Input({ transform: booleanAttribute }) format: boolean = this._componentDefaults?.inputNumber?.format ?? true;
    /**
     * Layout of the buttons, valid values are "stacked" (default), "horizontal" and "vertical".
     * @group Props
     */
    @Input() buttonLayout: string = this._componentDefaults?.inputNumber?.buttonLayout ?? 'stacked';
    /**
     ...
     * @group Props
     */
    @Input() incrementButtonIcon: string | undefined = this._componentDefaults?.inputNumber?.incrementButtonIcon;
    /**
     * Style class of the decrement button.
     * @group Props
     */
    @Input() decrementButtonIcon: string | undefined = this._componentDefaults?.inputNumber?.decrementButtonIcon;
    /**
     ...
     * @group Props
     */
    @Input({ transform: booleanAttribute }) allowEmpty: boolean = this._componentDefaults?.inputNumber?.allowEmpty ?? true;
    /**
     * Locale to be used in formatting.
     * @group Props
     */
    @Input() locale: string | undefined = this._componentDefaults?.inputNumber?.locale;
    /**
     * The locale matching algorithm to use. Possible values are "lookup" and "best fit"; the default is "best fit". See Locale Negotiation for details.
     * @group Props
     */
    @Input() localeMatcher: any = this._componentDefaults?.inputNumber?.localeMatcher;
    /**
     * Defines the behavior of the component, valid values are "decimal" and "currency".
     * @group Props
     */
    @Input() mode: string | any = this._componentDefaults?.inputNumber?.mode ?? 'decimal';
    /**
     * The currency to use in currency formatting. Possible values are the ISO 4217 currency codes, such as "USD" for the US dollar, "EUR" for the euro, or "CNY" for the Chinese RMB. There is no default value; if the style is "currency", the currency property must be provided.
     * @group Props
     */
    @Input() currency: string | undefined = this._componentDefaults?.inputNumber?.currency;
    /**
     * How to display the currency in currency formatting. Possible values are "symbol" to use a localized currency symbol such as €, ü"code" to use the ISO currency code, "name" to use a localized currency name such as "dollar"; the default is "symbol".
     * @group Props
     */
    @Input() currencyDisplay: string | undefined | any = this._componentDefaults?.inputNumber?.currencyDisplay;
    /**
     * Whether to use grouping separators, such as thousands separators or thousand/lakh/crore separators.
     * @group Props
     */
    @Input({ transform: booleanAttribute }) useGrouping: boolean = this._componentDefaults?.inputNumber?.useGrouping ?? true;
    /**
     * The minimum number of fraction digits to use. Possible values are from 0 to 20; the default for plain number and percent formatting is 0; the default for currency formatting is the number of minor unit digits provided by the ISO 4217 currency code list (2 if the list doesn't provide that information).
     * @group Props
     */
    @Input({ transform: (value: unknown) => numberAttribute(value, undefined) }) minFractionDigits: number | undefined = this._componentDefaults?.inputNumber?.minFractionDigits;
    /**
     * The maximum number of fraction digits to use. Possible values are from 0 to 20; the default for plain number formatting is the larger of minimumFractionDigits and 3; the default for currency formatting is the larger of minimumFractionDigits and the number of minor unit digits provided by the ISO 4217 currency code list (2 if the list doesn't provide that information).
     * @group Props
     */
    @Input({ transform: (value: unknown) => numberAttribute(value, undefined) }) maxFractionDigits: number | undefined = this._componentDefaults?.inputNumber?.maxFractionDigits;
    /**
     * Text to display before the value.
     * @group Props
     */
    @Input() prefix: string | undefined = this._componentDefaults?.inputNumber?.prefix;
    /**
     * Text to display after the value.
     * @group Props
     */
    @Input() suffix: string | undefined = this._componentDefaults?.inputNumber?.suffix;
    /**
     ...
     * @group Props
     */
    @Input({ transform: booleanAttribute }) showClear: boolean = this._componentDefaults?.inputNumber?.showClear ?? false;
    /**
